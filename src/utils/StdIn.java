package utils; /*************************************************************************
 *  Compilation:  javac utils.StdIn.java
 *  Execution:    java utils.StdIn   (interactive dataStructure.test of basic functionality)
 *
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to utils.StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from In to utils.StdIn */

    /*** begin: section (2 of 2) of code duplicated from In to utils.StdIn,
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from In to utils.StdIn */
    
    
    /**
     * If utils.StdIn changes, use this to reinitialize the scanner.
     */
    ...
    // do this once when utils.StdIn is initialized
    static {
        resync();
    }
   ...
   /**
    ...
    /**
     * Interactive dataStructure.test of basic functionality.
     */
